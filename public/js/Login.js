...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_3__.mapActions)(['login', 'getFollowings', 'getFollowers'])), {}, {
    ...
    setToEmail: function setToEmail() {
      this.signinWith = 'email';
      this.clearCredentials();
    },
    setToUsername: function setToUsername() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(_this.signinWith === 'username' && _this.username === '')) {
                  _context.next = 5;
                  break;
                }

                _this.errorMessage = 'Please enter your username in the field.';
                _this.usernameError = true;
                _context.next = 31;
                break;

              case 5:
                if (!(_this.signinWith === 'email' && _this.email === '')) {
                  _context.next = 10;
                  break;
                }

                _this.errorMessage = 'Please enter your email in the field.';
              ...
              case 10:
                ...
                _this.errorMessage = 'Please enter your password in the field.';
                _this.passwordError = true;
                _context.next = 31;
                break;

              case 15:
                if (!(_this.username.trim().length < 8)) {
                  _context.next = 20;
                  break;
                }

                _this.errorMessage = 'Please your username is too short.';
                _this.usernameError = true;
                _context.next = 31;
                break;

              case 20:
                if (!(_this.password.trim().length < 8)) {
                  _context.next = 25;
                  break;
                }

                _this.errorMessage = 'Please your password is too short.';
                _this.emailError = true;
                _context.next = 31;
                break;
              ...
              case 25:
                ...
                _context.next = 30;
                return _this.login(loginCredentials);

              case 30:
                _this.followersAndFollowings();
    ...
    followersAndFollowings: function followersAndFollowings() {
      var _this2 = this;
  ...
  return _c(
    ...
    [
      ...
      _c("login-register-outline", {
        attrs: { title: "Login", theErrorMessage: _vm.errorMessage },
            ...
            fn: function() {
              return [
                ...
                _c(
                  "button",
                  {
                    staticClass: "btn login-btn my-auto",
                    on: {
                ...
                _vm._v(" "),
                _c("div", { staticClass: "login-with" }, [
                  _vm.signinWith === "username"
                    ? _c(
                        "button",
                        {
                          staticClass: "btn login-type-btn",
                          on: {
                            click: function($event) {
                              $event.preventDefault()
                              return _vm.setToEmail.apply(null, arguments)
                            }
                          }
                        },
                        [_vm._v("use email")]
                    ...
                    ? _c(
                        "button",
                        {
                          ...
                          on: {
                            click: function($event) {
                              $event.preventDefault()
                              return _vm.setToUsername.apply(null, arguments)
                            }
                          }
                        },
                        [_vm._v("use username")]
